          ...
          <div class="row justify-between" style="max-width: 768px">
            <div class="infoBox">
              <div class="infoBoxContent">
                ...
                <div class="value">
                  <span><FormatWorktips :amount="tx.amount" raw-value/></span>
                </div>
              </div>
            </div>
            ...
            <div class="infoBox">
              <div class="infoBoxContent">
                ...
                <div class="value">
                  <span><FormatWorktips :amount="tx.fee" raw-value/></span>
                </div>
              </div>
            </div>
              ...
              <template v-if="out_destinations">
                <q-item v-for="destination in out_destinations" :key="destination.address" class="q-px-none">
                  <q-item-label>
                    ...
                    <q-item-label><FormatWorktips :amount="destination.amount"/></q-item-label>
                  </q-item-label>
