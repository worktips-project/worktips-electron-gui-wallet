    ...
    <q-layout>
      ...
      <q-page-container class="detail-page">
        <div class="layout-padding">
          ...
          <div class="info row justify-between">
            <div class="infoBox">
              <div class="infoBoxContent">
                ...
                <div class="value">
                  <span
                    ><FormatWorktips :amount="node.staking_requirement" raw-value
                  /></span>
                </div>
              </div>
            </div>
            <div class="infoBox">
              <div class="infoBoxContent">
                ...
                <div class="value">
                  <span
                    ><FormatWorktips :amount="node.total_contributed" raw-value
                  /></span>
                </div>
              </div>
            </div>
          ...
          <q-list no-border :dark="theme == 'dark'" class="worktips-list">
            ...
            >
              <q-item-label>
                ...
                <q-item-label class="non-selectable" caption>
                  ...
                  <FormatWorktips :amount="contributor.amount" raw-value />
                </q-item-label>
              </q-item-label>
              <ContextMenu
...
export default {
  ...
  methods: {
    openUserWalletInfo(contributorAddress) {
      const url = `https://www.worktipssn.com/user/${contributorAddress}`;
